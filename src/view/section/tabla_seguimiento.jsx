...
export function TablaSeguimiento1() {
...
export function TablaSeguimiento2() {
  const [page, setPage] = React.useState(0);
  const [rowsPerPage, setRowsPerPage] = React.useState(10);
...
export function TablaSeguimiento3() {
  const [page, setPage] = React.useState(0);
  const [rowsPerPage, setRowsPerPage] = React.useState(10);
